...
$H_O$: there is no relationship between getting aides and taking abacavirinol for gays

$H_1$: there is a relationship between getting aides and taking abacavirinol gays
...
```
The drug is not working for the gays because 72% of the ones that took the drug still got aids and only 27% of the gays that got the placebo got aids.
...
colPerc(table1)
```
The drug is not working because at least 40% of the guys that took the drug got aides
## Inferential Results
...
fisher.test(table1)
```
Because the p value is 2.998e-08 which is less tha 0.5, I reject the null hypothesis.
 
# Discussion and Conclusion

<!--Discussion and conclusion here.  If you found a relationship be sure to consider whether the relationship occurs because one of the variavbles causes the other, or whether they perhasps are related for some other reason.  Watch the chapter 6 videos from the GeorgeTown videos collection.!--> There is no relationship betwwen the drug and the placebo because way more gays that took the drug got aids than the ones that got the placebo. An almost equal amount that took the placebo and drug didnt get aids. 
